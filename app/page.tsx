...
import { Lock, History, TrendingUp, Sparkles } from "lucide-react"
...
export default async function BonusHuntPage() {
  ...
  const highestMultiplierData = completedHunts.reduce(
    ...
    { multiplier: 0, game: "", provider: null as string | null, betsize: 0, amount: 0 },
  )
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-amber-300 text-sm font-bold">
                    ...
                    {highestMultiplierData.amount > 0 && (
                      <span className="text-xs ml-1">(${highestMultiplierData.amount.toFixed(2)})</span>
                    )}
                  </p>
                </div>
              </div>
